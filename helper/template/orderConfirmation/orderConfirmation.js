...
const logo =
  "https://raw.githubusercontent.com/toth2000/storeX-server/20b488f936f406a4e54a5c7c91536d5fe2a5ebf3/logo.svg";

const oderConfirmationEmailTemplate = async (order) => {
  const dateAndTime = getOrderDateAndTime(order);
  const orderId = order._id;
  const address = getAddress(order);
  const phone = order.phone;
  const firstName = order.address.firstName;
  const lastName = order.address.lastName;
  const products = await getAllProductsDetails(order.products);
  ...
  const tax = ((total - shipping) * (order?.taxPercentage / 100)).toFixed(2);
      ...
      <center>
        <table cellspacing="0" cellpadding="0" width="600" class="w320">
          ...
          <tr>
            <td class="button">
              <div><!--[if mso]>
                <v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="http://store-x-website.vercel.app/" style="height:45px;v-text-anchor:middle;width:155px;" arcsize="15%" strokecolor="#ffffff" fillcolor="#ff6f6f">
                  <w:anchorlock/>
                ...
                <table cellspacing="0" cellpadding="0" width="100%">
                    ...
                    .map(
                      ...
                      <td class="item-col item">
                        <table cellspacing="0" cellpadding="0" width="100%">
                          <tr>
                            <td class="mobile-hide-img">
                              <a href=""><img width="150" height="auto" src=${
                                item.image
                              } alt="item1"></a>
                            </td>
                            <td class="product">
                              ...
                              Color: ${item.color.color.toUpperCase()} <br />
                            </td>
                          </tr>
                        </table>
                      </td>
                  ...
                  <tr>
                    ...
                    <td class="item-col price" style="text-align: left; border-top: 1px solid #cccccc;">
                      <span class="total-space">INR ${price}</span> <br />
                      <span class="total-space">INR ${tax}</span>  <br />
                      <span class="total-space">INR ${subtotal}</span>  <br />
                      <span class="total-space">INR ${shipping}</span>  <br />
                      <span class="total-space" style="font-weight:bold; color: #4d4d4d">INR ${total}</span>
                    </td>
                  </tr>  
                </table>
              </td>
...
module.exports = oderConfirmationEmailTemplate;
